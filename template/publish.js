...
function buildNav(members) {
  ...
  if (members.modules.length) {
    ...
    /*members.modules.forEach(function(m) {
        console.log("longname is " + m.longname);
      if (!hasOwnProp.call(seen, m.longname)) {

          var newLongName = linkto(m.longname, m.longname.replace("module:", ""));
          console.log(newLongName);
          nav.module.members.push(newLongName);
      }
      seen[m.longname] = true;
    });*/
      var tpl = require("./big-template.js");
      console.log(tpl);
      nav.module.members.push(tpl);
  }
